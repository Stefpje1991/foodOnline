...
# Restrict the customer from accessing the vendorDashboard
...
def registerVendor(request):
    if request.user.is_authenticated:
        ...
        if form.is_valid() and v_form.is_valid():
            ...
            messages.success(request, 'Your company has been registered successfully. Please wait for the approval.')
...
def forgot_password(request):
    if request.method == 'POST':
        ...
        if User.objects.filter(email=email).exists():
            ...
            mail_subject = 'Reset Your Password on foodOnline'
